            ...
            <div id="page-wrapper">
                <div class="container-fluid">
					...
					<div class="form-group">
						...
						<input class="form-control" placeholder="Nama Admin" name="nama" id="nama" autocomplete="off" autofocus required>
					</div>
					<div class="form-group">
					...
					<button type="submit" class="btn btn-primary" name="input_admin">Input Admin</button>
                    </form>
				</div>
        </div>
        <!-- /#wrapper -->
