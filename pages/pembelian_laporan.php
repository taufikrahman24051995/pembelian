...
$beli = mysqli_query($koneksi, "SELECT * FROM beli INNER JOIN detail_beli ON beli.kode_beli = detail_beli.kode_beli INNER JOIN pemasok ON beli.kode_pemasok = pemasok.kode_pemasok INNER JOIN admin ON beli.kode_admin = admin.kode_admin INNER JOIN barang ON barang.kode_barang = detail_beli.kode_barang ORDER BY beli.kode_beli ASC");
...
$pdf->Cell(28,0.7,"Data Pembelian",0,10,'C');
$pdf->ln(1);
...
$pdf->Cell(3, 0.8, 'Kode Beli', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Tanggal', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Admin', 1, 0, 'C');
$pdf->Cell(4, 0.8, 'Pemasok', 1, 0, 'C');
...
$pdf->Cell(24.25, 0.8, "Total Pembelian",1, 0, 'C');
