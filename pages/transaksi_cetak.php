...
$pdf->Cell(4, 0.8, 'Kode Beli', 1, 0, 'C');
...
foreach ($transaksi as $lihat) {
 ...
 $pdf->Cell(1, 0.8, $no, 1, 0, 'C');
 $pdf->Cell(4, 0.8, $lihat['kode_beli'], 1, 0,'C');
 $pdf->Cell(3.50, 0.8, $lihat['nama'], 1, 0,'C');
