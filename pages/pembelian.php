        ...
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="pembelian.php" class="active"><i class="fa fa-money fa-fw"></i> Data Pembelian</a>
                            </li>
                            <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-money fa-fw"></i> Data Pembelian</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="transaksi.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Input Pembelian</button></a>
                                </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><div align="center">Kode Beli</div></th>
                                                    <th><div align="center">Tanggal</div></th>
                                                    <th><div align="center">Admin</div></th>
                                                    <th><div align="center">Pemasok</div></th>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?php echo $row["kode_beli"]; ?></td>
